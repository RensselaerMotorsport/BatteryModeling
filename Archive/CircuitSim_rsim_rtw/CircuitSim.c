...
const char *gblSlvrJacPatternFileName =
  "CircuitSim_rsim_rtw\\CircuitSim_Jpattern.mat";
...
{
  /* SimscapeLtiOutput: '<S4>/LTI_OUTPUT_1_1' */
  rtB.LTI_OUTPUT_1_1 = 6.0;
...
SimStruct * CircuitSim(void)
{
  ...
  ssSetModelName(rtS, "CircuitSim");
  ssSetPath(rtS, "CircuitSim");
  ssSetTStart(rtS, 0.0);
  ...
  ssSetChecksumVal(rtS, 0, 2708444612U);
  ssSetChecksumVal(rtS, 1, 2767931868U);
  ssSetChecksumVal(rtS, 2, 686631409U);
  ssSetChecksumVal(rtS, 3, 1630739551U);
  return rtS;
}
